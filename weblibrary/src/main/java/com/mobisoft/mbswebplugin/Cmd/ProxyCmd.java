...
import com.mobisoft.mbswebplugin.Cmd.DoCmd.ShowNavBar;
...
public class ProxyCmd {
    ...
    public void createMap() {
        ...
        hashmap.put(CMD.cmd_showNavBar, ShowNavBar.class.getName());
        hashmap.put(CMD.cmd_hideNavBar, HideNavBar.class.getName());

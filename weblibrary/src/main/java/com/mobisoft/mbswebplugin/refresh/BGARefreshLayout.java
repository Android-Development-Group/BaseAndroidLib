...
//                    Log.i("OBO","mInterceptTouchDownX:"+mInterceptTouchDownX);
//                    Log.i("OBO","mInterceptTouchDownY:"+mInterceptTouchDownY);

                    int interceptTouchMoveDistanceY = (int) (event.getRawY() - mInterceptTouchDownY);
//                    Log.i("OBO","interceptTouchMoveDistanceY:"+interceptTouchMoveDistanceY);
//                    Log.e("OBO","event.getRawX() - mInterceptTouchDownX:"+(event.getRawX() - mInterceptTouchDownX));
...
//                        Log.i("OBO","452行:");
//                        Log.i("OBO","shouldHandleRefresh:"+shouldHandleRefresh());
//                        Log.i("OBO","shouldHandleLoadingMore:"+shouldHandleLoadingMore());

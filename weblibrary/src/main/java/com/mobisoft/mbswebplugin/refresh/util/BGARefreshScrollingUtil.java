...
//    }
    public static boolean isX5WebViewToBottom(com.tencent.smtt.sdk.WebView webView) {
        Log.e("OBC", "getScrollY:"+webView.getView().getScrollY() );
        Log.e("OBC", "getMeasuredHeight:"+webView.getView().getMeasuredHeight() );
        Log.e("OBC", "getHeight:"+webView.getView().getHeight() );
        Log.i("OBC", "getHeight "+webView.getHeight() );
        Log.i("OBC", "getMeasuredHeight "+webView.getMeasuredHeight() );
        Log.i("OBC", "getScrollY "+webView.getScrollY());
        Log.i("OBC", "getContentHeight "+webView.getContentHeight());
        Log.i("OBC", "getScale "+webView.getScale());
        Log.i("OBC", "density "+webView.getContext().getResources().getDisplayMetrics().density);
        return webView != null && webView.getContentHeight() * webView.getContext().getResources().getDisplayMetrics().density == (webView.getView().getScrollY() + webView.getView().getMeasuredHeight());
    }
